...
TabbyMcTabface uses Seam-Driven Development. Read [agents.md](./agents.md) and [the seam catalog](./docs/seam-catalog.md) before changing production code.
